# This script will generate an html page, titled like the top folder that contains this script
# From this html page, a link to each of the pages in the markdown folder will be created
# To NOT generate this page, simply name the .md file the same as the top folder that contains this script
